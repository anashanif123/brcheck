    ...
    <div className="bg-slate-900 bg-opacity-90 backdrop-blur-md border-b border-white/10 shadow-sm px-4 py-3 md:px-6">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center">
          <div className="hidden md:flex items-center text-sm md:text-base text-white">
            ...
            <button className="bg-sky-600 hover:bg-sky-700 font-medium py-1.5 px-3 rounded-md transition duration-200 mr-2">
              AMP
            </button>
            <button
              className="bg-blue-700 hover:bg-blue-800 font-medium py-1.5 px-3 rounded-md transition duration-200"
              onClick={onLoginClick} // Call the function passed from Home
            >
              Login
            </button>
          </div>
      ...
      {isOpen && (
        <div className="md:hidden mt-3 space-y-2 text-white">
          ...
          <button className="block w-full bg-sky-600 hover:bg-sky-700 font-medium py-2 px-4 rounded-md transition duration-200">
            AMP
          </button>
          <button
            className="block w-full bg-blue-700 hover:bg-blue-800 font-medium py-2 px-4 rounded-md transition duration-200"
            onClick={onLoginClick} // Call the function passed from Home
          >
            Login
          </button>
